(function() {
    ...
    /* الحساب المالي المباشر مع تفعيل العزل الصارم والمحكم للشركات ١٠٠٪ */
    window.getCompanyFinancials = function() {
        ...
        /* دالة تصفية وتطبيق العزل الصارم بحسب companyId للشركة الحالية فقط دون أي استثناءات */
        let filterComp = (arr) => {
        ...
        /* حساب رصيد الخزينة المباشر للشركة */
        let cashNum = 0;
